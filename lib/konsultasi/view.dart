...
class KonsultasiOrtu extends StatefulWidget {
  KonsultasiOrtu({Key? key}) : super(key: key);

  @override
  _KonsultasiOrtuState createState() => _KonsultasiOrtuState();
}

List _listsData = [];

class _KonsultasiOrtuState extends State<KonsultasiOrtu> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          MessageBar(
            onSend: (message) async => {HttpServiceChat.sendMessage(message, context),KonsultasiChat()},
            actions: [
              InkWell(
                child: Icon(
                  Icons.add,
